...
class ProfileViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadImages() {
        viewModelScope.launch {
            val imageList = queryImages(getApplication<Application>().contentResolver)
    ...
    private suspend fun queryImages(cr: ContentResolver): List<MediaStoreImage> {
        ...
        withContext(Dispatchers.IO) {
            ...
            cr.query(
                ...
                Log.i("IMAGE_CURSOR", "Found ${cursor.count} images")
